...
class UserActivityLogServiceTest {
    ...
    private val userActivityLogService = UserActivityLogService(userActivityLogRepository)
    ...
    fun `should log activity successfully`() {
        ...
        userActivityLogService.logActivity(userId, action, details)
    ...
    fun `should get logs by userId successfully`() {
        ...
        val result = userActivityLogService.getLogsByUserId(userId)
    ...
    fun `should get logs by action successfully`() {
        ...
        val result = userActivityLogService.getLogsByAction(action)
    ...
    fun `should get logs by timestamp range successfully`() {
        ...
        val result = userActivityLogService.getLogsByTimestampRange(start, end)
    ...
    fun `should get all logs successfully`() {
        ...
        val result = userActivityLogService.getAllLogs()
