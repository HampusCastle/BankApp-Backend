...
import hampusborg.bankapp.presentation.controller.UserProfileController
...
class UserProfileControllerTest {
    ...
    fun `should update user profile successfully`() {
        ...
        val request = UserProfileUpdateRequest(username = "newusername", email = "newemail@example.com", password = "Newpassword123")
